        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <h3>Emargency</h3>
                    <form action="{{route('emercency.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <section>
                            <div class="form-group row">
                                <label class="col-lg-2 control-label" for="name1"> emargency Number *</label>
                                <div class="col-lg-10">
                                    <input id="name1" name="phone" type="text" class="required form-control" required="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 control-label" for="name1"> emargency Number for reason </label>
                                <div class="col-lg-10">
                                    <input id="name1" name="phone_for_resion" type="text" class="required form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 control-label" for="name1"> emargency Email</label>
                                <div class="col-lg-10">
                                    <input id="name1" name="email" type="text" class="required form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 control-label" for="name1"> Positioning Order </label>
                                <div class="col-lg-10">
                                    <input id="name1" name="postion" type="text" class="required form-control">
                                </div>
                            </div>
                            <div class="form-group row">
