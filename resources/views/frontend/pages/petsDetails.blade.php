  ...
  <div class="row">
    ...
    @endforeach
        ...
        <div class="image-gallery">
          ...
          <!-- Modal -->
          <div class="modal fade" id="exampleModal{{$pets->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="single-product my-3">
                    <div class="card mb-3">
                      <a href="{{url('/ads-details',$pets->id)}}">
                        <div class="row no-gutters">
                          ...
                          <div class="col-md-8">
                            <div class="card-body">
                              <?php
                              $brandName = DB::table('brands')->where('id',$pets->brand)->first();
                              $modelName = DB::table('models')->where('id',$pets->model)->first();
                              ?>
                              <h5 class="card-title">{{$pets->title}}</h5>
                              <?php
                              if(isset($pets->price)){
                              ?>
                              <span id="pointer">
                              ...
                              <p class="pointer" id="pointer">Tk. {{$pets->price}}</p>
                              <?php }else{ ?>
                              <p class="card-text">N/A</p>
                              <?php } ?>
                              <p class="card-text"><small class="text-muted"></small></p>
                              <p class="card-text float-right"><small class="text-muted">{{ Carbon\Carbon::parse($pets->created_at)->diffForHumans()}} </small></p>
                            </div>
                          </div>
                        </div>
                      </a>
                  ...
                  <div class="modal-footer">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <div class="input-group-append">
                        ...
                        <input type="hidden" name="product_id" value="{{$pets->id}}">
                        <input type="hidden" name="to" value="{{$pets->user_id}}">
        ...
        <div class="ads-content">
          ...
          <h1 class="">{{$pets->title}}</h1>
          <p id="pointer"><b>Price : </b>Tk. {{$pets->price}}</p>
          <br>
          <hr>
          <div class="features">
            <h3>Fatures</h3>
            <ul>
              <?php
              $featuress = explode(',', $pets->features);
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <h6 class="mt-0" data-toggle="modal" data-target="#exampleModal{{$pets->id}}"> CHAT </h6>
                </div>
              </div>
              <hr>
              ...
              <a href="{{url('/promote/ads',$pets->id)}}" class="btn btn-info">Promote this ads</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="ads-content">
          ...
          $user_details = DB::table('users')->join('pets_animals','pets_animals.user_id','=','users.id')->where('users.id',$pets->user_id)->get();
          ?>
