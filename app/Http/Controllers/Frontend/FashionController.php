...
class FashionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $fashion = new FashionHealthBeauty();
        $fashion->category_id = $request->category_id;
        $fashion->image = implode(',', $data);
        $fashion->sub_category_id = $request->sub_category_id;
        $fashion->title = $request->title;
        $fashion->division_id = $request->division_id;
        $fashion->city_id = $request->city_id;
        ...
        $fashion->item_type = $request->item_type;
        $fashion->na = $request->na;
        $fashion->save();
        return back();
    }
