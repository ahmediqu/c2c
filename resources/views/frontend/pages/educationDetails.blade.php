...
<div class="">
  <?php
          ...
          $pImage = explode(',',$education->image);
          // echo $pImage['0'];
          $i=0;
    ?>
  ...
  <div class="row">
    ...
    @endforeach
        ...
        <div class="image-gallery">
          ...
          <!-- Modal -->
          <div class="modal fade" id="exampleModal{{$education->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="single-product my-3">
                    <div class="card mb-3">
                      <a href="{{url('/ads-details',$education->id)}}">
                        <div class="row no-gutters">
                          ...
                          <div class="col-md-8">
                            <div class="card-body">
                              <?php
                              $brandName = DB::table('brands')->where('id',$education->brand)->first();
                              $modelName = DB::table('models')->where('id',$education->model)->first();
                              ?>
                              <h5 class="card-title">{{$education->title}}</h5>
                              <?php
                              if(isset($education->price)){
                              ?>
                              <span id="pointer">
                                
                              </span>
                              <p class="pointer" id="pointer">Tk. {{$education->price}}</p>
                              <?php }else{ ?>
                              <p class="card-text">N/A</p>
                              <?php } ?>
                              <p class="card-text"><small class="text-muted"></small></p>
                              <p class="card-text float-right"><small class="text-muted">{{ Carbon\Carbon::parse($education->created_at)->diffForHumans()}} </small></p>
                            </div>
                          </div>
                        </div>
                      </a>
                  ...
                  <div class="modal-footer">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <div class="input-group-append">
                        ...
                        <input type="hidden" name="product_id" value="{{$education->id}}">
                        <input type="hidden" name="to" value="{{$education->user_id}}">
        ...
        <div class="ads-content">
          ...
          <p id="pointer"><b>Price : </b>Tk. {{$education->price}}</p>
          <br>
          <hr>
          <div class="features">
            <h3>Fatures</h3>
            <ul>
              <?php
              $featuress = explode(',', $education->features);
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <h6 class="mt-0" data-toggle="modal" data-target="#exampleModal{{$education->id}}"> CHAT </h6>
                </div>
              </div>
              <hr>
              ...
              <a href="{{url('/promote/ads',$education->id)}}" class="btn btn-info">Promote this ads</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="ads-content">
          ...
          $user_details = DB::table('users')->join('education','education.user_id','=','users.id')->where('users.id',$education->user_id)->get();
          ?>
