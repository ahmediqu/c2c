  ...
  <div class="row">
    ...
    @endforeach
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="single-product my-3">
                    <div class="card mb-3">
                      <a href="{{url('/business-and-industry/details',$business->id)}}">
                        <div class="row no-gutters">
                          ...
                          <div class="col-md-8">
                            <div class="card-body">
                              <?php
                              $brandName = DB::table('brands')->where('id',$business->brand)->first();
                              $modelName = DB::table('models')->where('id',$business->model)->first();
                              ?>
                              ...
                              <p class="pointer" id="pointer">Tk. {{$business->price}}</p>
                              <?php }else{ ?>
                              <p class="card-text">N/A</p>
                              <?php } ?>
                              <p class="card-text"><small class="text-muted"></small></p>
                              <p class="card-text float-right"><small class="text-muted">{{ Carbon\Carbon::parse($business->created_at)->diffForHumans()}} </small></p>
                            </div>
                          </div>
                        </div>
                      </a>
                  ...
                  <div class="modal-footer">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <div class="input-group-append">
                        ...
                        <input type="hidden" name="to" value="{{$business->user_id}}">
        ...
        <div class="ads-content">
          ...
          <h1 class="">{{$business->title}}</h1>
          <p id="pointer"><b>Price : </b>Tk. {{$business->price}}</p>
          <br>
          <hr>
          <div class="features">
            <h3>Fatures</h3>
            <ul>
              <?php
              $featuress = explode(',', $business->features);
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <h6 class="mt-0" data-toggle="modal" data-target="#exampleModal{{$business->id}}"> CHAT </h6>
                </div>
              </div>
              <hr>
              ...
              <a href="{{url('/promote/ads',$business->id)}}" class="btn btn-info">Promote this ads</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="ads-content">
          ...
          $user_details = DB::table('users')->join('sell_services','sell_services.user_id','=','users.id')->where('users.id',$business->user_id)->get();
          ?>
          ...
          <div class="row" style="background: #fff;padding: 10px;">
            ...
            <div class="col-md-4">
              ...
              <div class="all-product">
                ...
                ?>
                <a href="{{url('business-and-industry/details',$ads->id)}}">
                  <div class="media ">
