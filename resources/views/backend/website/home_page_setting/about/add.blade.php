                    ...
                    <form action="{{route('aboutus.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <section>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea name="description" id="summernote" cols="10" rows="5" class="form-control summernote"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input id="name1" name="link" type="text" class="required form-control" required="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 control-label" for="name1">Embade Vedio</label>
                                <div class="col-lg-10">
                                    <input id="name1" name="vedio_embade" type="text" class="required form-control">
                                </div>
                            </div>
                            <div class="form-group row">
