...
@section('front-page-title',' | Product Details ')
...
<img src="{{url('frontend/assets/images/banners/LHS-banner.jpg')}}" alt="Image">
</div>    
            ...
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  <div class="image"> 
                  <a href="#">
                  <img src="{{url('frontend/assets/images/hot-deals/p13.jpg')}}" alt=""> 
                  <img src="{{url('frontend/assets/images/hot-deals/p13_hover.jpg')}}" alt="" class="hover-image">
                  </a>
                  </div>
            ...
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  <div class="image"> 
                   <a href="#">
                  <img src="{{url('frontend/assets/images/hot-deals/p14.jpg')}}" alt=""> 
                  <img src="{{url('frontend/assets/images/hot-deals/p14_hover.jpg')}}" alt="" class="hover-image">
                  </a>
                   </div>
            ...
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  <div class="image">
                   <a href="#">
                  <img src="{{url('frontend/assets/images/hot-deals/p15.jpg')}}" alt=""> 
                  <img src="{{url('frontend/assets/images/hot-deals/p15_hover.jpg')}}" alt="" class="hover-image">
                  </a>
                   </div>
                  <div class="sale-offer-tag"><span>35%<br>
                    off</span></div>
...
<?php $product_image = explode(',',$product_details->image);?>
        ...
        <div id="owl-single-product">
          ...
          @foreach($product_image as $img)
            <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="Gallery" href="{{url($img)}}">
                    <?php echo "<img class='img-responsive' alt='' src='".asset($img)."'  data-echo='".asset($img)."' />";?>
                </a>
                    ...
                    <div class="price-box">
                     <!--  <span class="price">$800.00</span>
                      <span class="price-strike">$900.00</span> -->
                       @if($product_details->sale_price !== null && $product_details->sale_price > 0)
                                            BDT <span class="price-strike">{{ $product_details->price }}</span> BDT {{ $product_details->sale_price }}
                                        @else
                                            BDT <span class="price">{{ $product_details->price }}</span>
                                        @endif 
                    </div>
                  </div>
