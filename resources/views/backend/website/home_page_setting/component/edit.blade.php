        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <a href="{{url('admin/component')}}" class="btn btn-outline-info float-right">Back</a>
                    <h3>Component</h3>
                    <form action="{{route('component.update',$component->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <section>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input id="name1" name="title" type="text" class="required form-control" required="" value="{{$component->title}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 control-label " for="surname1"> Description </label>
                                <div class="col-lg-10">
                                    <textarea name="description" id="" cols="10" rows="5" class="form-control">{{$component->description}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input id="name1" name="link" type="text" class="required form-control" required="" value="{{$component->link}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 control-label" for="name1">Link</label>
                                <div class="col-lg-10">
                                    <input id="name1" name="position" type="text" class="required form-control" required="" value="{{$component->position}}">
                                </div>
                            </div>
                            <div class="form-group row">
