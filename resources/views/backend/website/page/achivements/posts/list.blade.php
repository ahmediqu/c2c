                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Achivements List</h4>
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                                            <table id="tech-companies-1" class="table table-striped table-bordered">
                                            	<a href="{{route('achivements.create')}}" class="btn btn-outline-info">Create Achivements </a><br><br>
                                                ...
                                                <tr>
                                                    ...
                                                    <th data-priority="1">Highlight</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$n->created_at}}</td>
                                                    <td> 
                                                    	<a href="{{route('achivements.edit',$n->id)}}" class="btn btn-outline-info"><i class="zmdi zmdi-edit"></i></a>

                                                    	<form action="{{route('achivements.destroy',$n->id)}}" method="POST" style="display: inline-block;">
            @method('DELETE')
            {{csrf_field()}}
