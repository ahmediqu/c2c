        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <a href="{{url('admin/blog')}}" class="btn btn-outline-info float-right">Back</a>
                    <h3>Blog Posts</h3>
                    <form action="{{route('blog.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <section>
                           ...
                           <div class="form-group row">
                                <label class="col-lg-2 control-label" for="name1">Blog Title</label>
                                <div class="col-lg-10">
                                    <input id="name1" name="blog_title" type="text" class="required form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 control-label " for="surname1"> Description </label>
                                <div class="col-lg-10">
                                    <textarea name="blog_description" id="" cols="10" rows="5" class="form-control summernote"></textarea>
                                </div>
                            </div>
