                    ...
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="tech-companies-1" class="table table-striped table-bordered">
                                <a href="{{route('quotation.create')}}" class="btn btn-outline-info">Create Quotation</a><br><br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('quotation.edit',$quotation->id)}}" class="btn btn-outline-info"><i class="zmdi zmdi-edit"></i></a>
