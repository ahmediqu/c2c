        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <a href="{{url('admin/news-category')}}" class="btn btn-outline-info float-right">Back</a>
                    <h3>News Category</h3>
                    <form action="{{route('news-category.update',$n_category->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <section>
