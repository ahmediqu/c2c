  ...
  <div class="row">
    ...
    @endforeach
        ...
        <div class="image-gallery">
          ...
          <!-- Modal -->
          <div class="modal fade" id="exampleModal{{$fashion->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="single-product my-3">
                    <div class="card mb-3">
                      <a href="{{url('/ads-details',$fashion->id)}}">
                        <div class="row no-gutters">
                          ...
                          <div class="col-md-8">
                            <div class="card-body">
                              <?php
                              $brandName = DB::table('brands')->where('id',$fashion->brand)->first();
                              $modelName = DB::table('models')->where('id',$fashion->model)->first();
                              ?>
                              <h5 class="card-title">{{$fashion->title}}</h5>
                              <?php
                              if(isset($fashion->price)){
                              ?>
                              <span id="pointer">
                                
                              </span>
                              <p class="pointer" id="pointer">Tk. {{$fashion->price}}</p>
                              <?php }else{ ?>
                              <p class="card-text">N/A</p>
                              <?php } ?>
                              <p class="card-text"><small class="text-muted"></small></p>
                              <p class="card-text float-right"><small class="text-muted">{{ Carbon\Carbon::parse($fashion->created_at)->diffForHumans()}} </small></p>
                            </div>
                          </div>
                        </div>
                      </a>
                  ...
                  <div class="modal-footer">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <div class="input-group-append">
                        ...
                        <input type="hidden" name="product_id" value="{{$fashion->id}}">
                        <input type="hidden" name="to" value="{{$fashion->user_id}}">
        ...
        <div class="ads-content">
          ...
          <h1 class="">{{$fashion->title}}</h1>
          <p id="pointer"><b>Price : </b>Tk. {{$fashion->price}}</p>
          <br>
          <hr>
          <div class="features">
            <h3>Fatures</h3>
            <ul>
              <?php
              $featuress = explode(',', $fashion->features);
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <h6 class="mt-0" data-toggle="modal" data-target="#exampleModal{{$fashion->id}}"> CHAT </h6>
                </div>
              </div>
              <hr>
              ...
              <a href="{{url('/promote/ads',$fashion->id)}}" class="btn btn-info">Promote this ads</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="ads-content">
          ...
          $user_details = DB::table('users')->join('fashion_health_beauties','fashion_health_beauties.user_id','=','users.id')->where('users.id',$fashion->user_id)->get();
          ?>
                ...
                <a href="{{url('/ads-details',$ads->id)}}">
                  <div class="media ">
                    ...
                    <div class="media-body">
                      ...
                      <h5 class="card-title">{{$ads->title}} ({{$ads->condition}})
                       ({{$ads->condition}})</h5>
                      <?php
                      if(isset($ads->price)){
                      ?>
