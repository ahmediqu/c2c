...
@section('front-page-title','Sell Quicker | Home And Living Details ')
@section('style')
<style>
...
<div class="">
  <?php
          ...
          $pImage = explode(',',$home_and_living->image);
          // echo $pImage['0'];
          $i=0;
    ?>
  ...
  <div class="row">
    ...
    @endforeach
        ...
        <div class="image-gallery">
          ...
          <!-- Modal -->
          <div class="modal fade" id="exampleModal{{$home_and_living->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="single-product my-3">
                    <div class="card mb-3">
                      <a href="{{url('/ads-details',$home_and_living->id)}}">
                        <div class="row no-gutters">
                          ...
                          <div class="col-md-8">
                            <div class="card-body">
                              ...
                              <h5 class="card-title">{{$home_and_living->title}}</h5>
                              <?php
                              if(isset($home_and_living->price)){
                              ?>
                              <span id="pointer">
                                
                              </span>
                              <p class="pointer" id="pointer">Tk. {{$home_and_living->price}}</p>
                              <?php }else{ ?>
                              <p class="card-text">N/A</p>
                              <?php } ?>
                              <p class="card-text"><small class="text-muted"></small></p>
                              <p class="card-text float-right"><small class="text-muted">{{ Carbon\Carbon::parse($home_and_living->created_at)->diffForHumans()}} </small></p>
                            </div>
                          </div>
                        </div>
                      </a>
                  ...
                  <div class="modal-footer">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <div class="input-group-append">
                        ...
                        <input type="hidden" name="product_id" value="{{$home_and_living->id}}">
                        <input type="hidden" name="to" value="{{$home_and_living->user_id}}">
        ...
        <div class="ads-content">
          ...
          <h1 class="">{{$home_and_living->title}}</h1>
          <p id="pointer"><b>Price : </b>Tk. {{$home_and_living->price}}</p>
          <br>
          <hr>
          <div class="features">
            <h3>Fatures</h3>
            <ul>
              <?php
              $featuress = explode(',', $home_and_living->features);
              ...
              <div class="edition">
                <h3>Edition</h3>
                <p>{{ $home_and_living->edition }}</p>
              </div> <hr>
              <div class="description">
                <h3>Description </h3>
                {{ $home_and_living->description }}
              </div>
              <br>
              <hr>
              <div class="contact">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <h6 class="mt-0" data-toggle="modal" data-target="#exampleModal{{$home_and_living->id}}"> CHAT </h6>
                </div>
              </div>
              <hr>
              ...
              <a href="#" class="twitter-icon"> <i class="fab fa-twitter"></i> </a>
                ...
                {{ $home_and_living->phone}}
              </div>
              <a href="{{url('/promote/ads',$home_and_living->id)}}" class="btn btn-info">Promote this ads</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="ads-content">
          ...
          $user_details = DB::table('users')->join('home_livings','home_livings.user_id','=','users.id')->where('users.id',$home_and_living->user_id)->get();
          ?>
